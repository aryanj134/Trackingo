...
val NetworkModule = module {
    ...
    single { provideRetrofit(BaseUrl.BASE_URL, get(), get()) }
    single(named("feedback")) { provideRetrofit(BaseUrl.BASE_URL, get(), get()) }
    single(named("feedbackRating")) { provideRetrofit(BaseUrl.BASE_URL, get(), get()) }
}
